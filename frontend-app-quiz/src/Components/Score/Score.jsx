...
const Score = () => {
  ...
  return (
    <div className="font-rubik text-[var(--blue-900)]">
      <header>
        <section className="flex flex-row justify-start items-center absolute top-0 left-0 ml-[var(--spacing-300) mt-4 px-[var(--spacing-300)]">
          ...
          >
            <img src={currentQuiz?.icon} alt={`${subject} icon`} className="w-[1.786rem] h-[1.786rem]" />
          </figure>
        ...
        <section className="dark:text-[var(--standard-white)">
          <h1 className="text-[2.5rem] font-light dark:text-[var(--standard-white)] leading-[2.5rem] text-left font-rubik font-light md:text-[4rem] md:leading-[4rem] lg:leading-[4rem]">
            Quiz Completed <br />
            <span className="font-rubik font-medium">You Scored...</span>
          </h1>
        </section>
      </header>
      <main className="w-full flex flex-col left-0 ml-[var(--spacing-300) mt-4 px-[var(--spacing-300)] bg-[var(--standard-white)] dark:bg-[var(--blue-850)] py-4 px-4 mt-[var(--spacing-200)] rounded-lg flex items-center md:rounded-2xl">
        <section className="flex justify-start items-start mt-8">
          ...
          >
            <img src={currentQuiz?.icon} alt="quiz icon" className="w-[1.786rem] h-[1.786rem]" />
          </figure>
